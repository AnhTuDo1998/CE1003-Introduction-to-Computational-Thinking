...
This Python script contain the source code and main body for the Telegram Bot named NTU_iCal_Bot.
...
This NTU_iCal_Bot solves that problem by receving inputs of modules and group index from users, generate and return an iCalendar file that is compatible to any existing calendar app.
